...
import customer.gajamove.com.gajamove_customer.adapter.RecyclerListAdapter;
...
import customer.gajamove.com.gajamove_customer.drag.DynamicListView;
...
import customer.gajamove.com.gajamove_customer.utils.SimpleItemTouchHelperCallback;
...
public class Create_Order_Screen extends BaseActivity implements DeleteCallback {
    ...
    private void getCurrentLocation(){
        ...
        GPSTracker gpsTracker = new GPSTracker(Create_Order_Screen.this);
    ...
    public void getLastLocation() {
        ...
        FusedLocationProviderClient locationClient = getFusedLocationProviderClient(Create_Order_Screen.this);

        if (ActivityCompat.checkSelfPermission(Create_Order_Screen.this,
                android.Manifest.permission.ACCESS_FINE_LOCATION) !=
                PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(Create_Order_Screen.this,
                    ...
                    public void onSuccess(Location loc) {
                        ...
                        try {
                            if (loc != null) {
                                ...
                                Geocoder geocoder;
                                List<Address> addresses;
                                geocoder = new Geocoder(Create_Order_Screen.this, Locale.getDefault());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create__order__screen);
        ...
        pickup.setLocation_title("");
        pickup.setLocation_name("");
        pickup.setLocation_id("-1");

        drop = new Prediction();
        drop.setLocation_title("");
        drop.setLocation_name("");
        drop.setLocation_id("-1");

        stopsArray.add(pickup);
        stopsArray.add(drop);


        sidePointAdapter = new SidePointAdapter(stopsArray.size(),Create_Order_Screen.this);
        ...
        findViewById(R.id.edit_pickup).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pickup_text.performClick();
            }
        });
        findViewById(R.id.edit_drop).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drop_off_text.performClick();
            }
        });
        findViewById(R.id.edit_stop).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                add_stop_lay.performClick();
            }
        });
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (chosen_date.equalsIgnoreCase("") || chosen_time.equalsIgnoreCase("")) {
                        Toast.makeText(Create_Order_Screen.this, "Invalid date and time", Toast.LENGTH_SHORT).show();
                        return;
            ...
            public void onClick(View v) {
               ...
               // calculateTotalDistance();
                ...
                if (is_confirmed){
                    ...
                    startActivity(new Intent(Create_Order_Screen.this,SelectVehicleScreen.class)
        ...
        pickup_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Create_Order_Screen.this,PickLocationScreen.class);
        ...
        confirm_pickup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (pickup_contact.getText().toString().trim().equalsIgnoreCase("")){
                        pickup_contact.setError("Please add contact number");
                        return;
                    }

                    if (pickup_contact.getText().toString().trim().length()<9){
                        pickup_contact.setError("Incomplete number(min 9 digits)");
                        return;
                    }else if (pickup_contact.getText().toString().trim().startsWith("0")){
                        pickup_contact.setError("Number cannot start with 0");
                        return;
                    }
        ...
        history_tab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Create_Order_Screen.this,OrderHistoryScreen.class));
        ...
        help_tab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Create_Order_Screen.this,FinanceScreen.class));
            }
        });
        ...
        profile_tab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Create_Order_Screen.this,SettingsScreen.class));
            }
        });
    ...
    private void enableTab(LinearLayout home_tab) {
        ((ImageView)home_tab.getChildAt(0)).setColorFilter(ContextCompat.getColor(Create_Order_Screen.this,R.color.theme_primary));
        ((TextView)home_tab.getChildAt(1)).setTextColor(ContextCompat.getColor(Create_Order_Screen.this,R.color.theme_primary));

    }

    private void disableTab(LinearLayout home_tab) {
        ((ImageView)home_tab.getChildAt(0)).setColorFilter(ContextCompat.getColor(Create_Order_Screen.this,R.color.dark_gray_color));
        ((TextView)home_tab.getChildAt(1)).setTextColor(ContextCompat.getColor(Create_Order_Screen.this,R.color.dark_gray_color));
    ...
    private void createRout(){
        ...
        try {
            new RideDirectionPointsDB(Create_Order_Screen.this).clearSavedPoints();
            Ride ride = new Ride();
    ...
    private void showCurrentDatetime() {
        ...
        try {
            ...
            SimpleDateFormat dateFormat = new SimpleDateFormat("dd MMM (EEE) yyyy", Locale.ENGLISH);
            SimpleDateFormat apidateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss a", Locale.ENGLISH);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data!=null){
            if (chooseStatus==ChooseStatus.PICKUP){
                ...
                drop = stopsArray.get(stopsArray.size()-1);
                String[] data_ = data.getData().toString().split(Pattern.quote("#"));
    ...
    private void getMEETPlaceDetails(String id){
        ...
        Constants.enableSSL(asyncHttpClient,Create_Order_Screen.this);
        asyncHttpClient.get(Create_Order_Screen.this, url, new AsyncHttpResponseHandler() {
                    ...
                    if (status.equalsIgnoreCase("OK")) {
                        {
                           ...
                           // Constants.meet = new LatLng(lat,lng);
                            ...
                            stopsArray.get(0).setLat(lat);
                            stopsArray.get(0).setLng(lng);
                    ...
                    if (status.equalsIgnoreCase("OK")) {
                        {
                           ...
                           // Constants.destination = new LatLng(lat,lng);
                            ...
                            stopsArray.get(stopsArray.size()-1).setLat(lat);
                            stopsArray.get(stopsArray.size()-1).setLng(lng);
                    ...
                    if (status.equalsIgnoreCase("OK")) {
                        {
                            ...
                            int lastIndex = stopsArray.size() - 1;
                            stopsArray.add(lastIndex,prediction);
   ...
   // SimpleDateFormat server_check_formt = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss", Locale.ENGLISH);
    private void checkIfdateAvailable(String time) {
        ...
        asyncHttpClient.get(Create_Order_Screen.this, Constants.Host_Address + "customers/check_schedule_job/" + date + "/"+UtilsManager.getApiKey(Create_Order_Screen.this)+"/" + customerId + "", new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("success")){
                        Toast.makeText(Create_Order_Screen.this,UtilsManager.makeInitialCapital(jsonObject.getString("message")),Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                try {
                    ...
                    Toast.makeText(Create_Order_Screen.this,"Server Error "+response,Toast.LENGTH_SHORT).show();
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            try {
                ...
                String address = Constants.getCompleteAddressString(Create_Order_Screen.this,location.getLatitude(),location.getLongitude());
                ...
                if (!address.equalsIgnoreCase("")){
                    getFusedLocationProviderClient(Create_Order_Screen.this).removeLocationUpdates(locationCallback);
                }
            }
            catch (Exception e){
                e.printStackTrace();
    ...
    private void getAdvertisment() {
        ...
        asyncHttpClient.get(Constants.Host_Address + "members/get_advertisements/"+UtilsManager.getApiKey(Create_Order_Screen.this)+"", new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
    ...
    private void showAdvertismentDialog() {
        ...
        dialog = new Dialog(Create_Order_Screen.this,R.style.DialogTheme);
        ...
        viewPager.setAdapter(new CustomPagerAdapter(Create_Order_Screen.this));
    ...
    public class CustomPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            Picasso.with(Create_Order_Screen.this).load(advertisementList.get(position).getAd_image()).into(imageView);
            ...
            if (advertisementList.size() > 1){
                ...
                if (position > 0 && position <= advertisementList.size()-1){
                    bwd.setVisibility(View.VISIBLE);
                }else {
                    bwd.setVisibility(View.GONE);
                }
