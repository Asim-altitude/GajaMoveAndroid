...
public class SidePointAdapter extends BaseAdapter {

    int items;
    Context context;

    public SidePointAdapter(int items, Context context) {
        this.items = items;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view==null)
            view = LayoutInflater.from(context).inflate(R.layout.side_point_item,null);
